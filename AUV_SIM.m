...
fprintf(['Gross roll work: %.6f J | legacy transfer proxy: %.6f J ' ...
    '(not motor input; efficiency unsupported).\n'], ...
...
function plotSimulationResults(T, Y, tau1, tau2, control, energy, momentum, ...
    ...
    if plots.energy
        ...
        plot(T, cumtrapz(T, grossInputPower), ...
            'LineWidth', 2, 'DisplayName', 'Legacy transfer proxy (not input energy)');
        hold off;
